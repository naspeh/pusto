...
Я уже лет семь использую gmail и в этот период несколько раз пытался уйти от него, но всегда 
...
есть и мне хочется создать единый настраиваемый интерфейс для них.
...
также подразумевает все аккаунты, хотя это возможно появится уже после первой версии).
