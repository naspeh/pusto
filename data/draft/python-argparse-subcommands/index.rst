...
раньше мне очень нравилось превращение функций в подкоманды. Это чистый argparse и если 
его интерфейс чаще использовать, то даже этот сложный интерфейс запомнится.
