...
Про первые шаги `писал на хабре (26.06.2012)`__, потом позже рассказывал на `Pycon Russia 
...
что уже ~1500 (6 мин на CI__ сервере, больше 10 процессов). Тесты удались, хотя некоторые 
места хотелось бы сделать лучше.
